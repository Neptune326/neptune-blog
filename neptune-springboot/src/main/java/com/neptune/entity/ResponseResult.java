...
public class ResponseResult<T> {
    ...
    public static <T> ResponseResult<T> result(boolean flag, String failMessage, String successMessage) {
        if (flag) {
            return response(HttpStatusEnum.SUCCESS.getCode(), true, successMessage, null);
        }
        return response(HttpStatusEnum.ERROR.getCode(), false, failMessage, null);
    }

    public static <T> ResponseResult<T> result(boolean flag, String failMessage) {
        if (flag) {
            return response(HttpStatusEnum.SUCCESS.getCode(), true, HttpStatusEnum.SUCCESS.getMessage(), null);
        }
        return response(HttpStatusEnum.ERROR.getCode(), false, failMessage, null);
    ...
    public static <T> ResponseResult<T> result(boolean flag) {
        if (flag) {
            return response(HttpStatusEnum.SUCCESS.getCode(), true, HttpStatusEnum.SUCCESS.getMessage(), null);
        }
        return response(HttpStatusEnum.ERROR.getCode(), false, HttpStatusEnum.ERROR.getMessage(), null);
